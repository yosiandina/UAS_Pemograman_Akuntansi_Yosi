...
<h4><b>Tambah Data Backup</b></h4>
<br>
<form action="{{ asset('views_backup_yosi/tambah_proses_yosi') }}" method="POST">
@csrf
<div class="mb-3 row">
    <label for="id_backup_yosi" class="col-sm-2 col-form-label">ID Backup</label>
    <div class="col-sm-10">
    <input type="integer" class="form-control" id="id_backup_yosi" name="id_backup_yosi">
    </div>
</div>
<div class="mb-3 row">
...
<div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input type="date" class="form-control" id="tgl_backup_yosi" name="tgl_backup_yosi">
    </div>
</div>
<div class="mb-3 row">
